...
impl TraceWithFullDetails {
    pub fn new(html_path: String, latency: f64, total_cost: f64, observations: Vec<models::ObservationsView>, scores: Vec<models::Score>, id: String, timestamp: String) -> TraceWithFullDetails {

...
impl PromptOneOf {
    pub fn new(prompt: Vec<models::ChatMessage>, name: String, version: i32, config: Option<serde_json::Value>, labels: Vec<String>, tags: Vec<String>, r#type: Type) -> PromptOneOf {
        PromptOneOf {
            prompt,
            name,
            version,
